            ...
            <div class="col-md-11">
                <div class="card box-shadow">
                    <div class="row ">
                        ...
                        <div class="col-md-6 py-5" style="background-image: url('svg/Loginbg.png');background-size:cover;">
                            <div class="py-5 px-5 white-text">
                                <h3 class=" white-text font-weight-bold mb-0 pb-0">
                                     Welcome The Tech2Edge
                                </h3>
                                ...
                                <div class="mt-4">
                                    ...
                                    {{-- <p class="mt-4 text-center">
                                        <a href="{{ route('register') }}" class="white-text ">Not a Member? Create Account</a>
                                    </p> --}}
